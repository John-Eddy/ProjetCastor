...
class ParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getParserTestData()
    {
        return array(
            ...
            array('div>.foo', array('CombinedSelector[Element[div] > Utils[Element[*].foo]]')),
            array('div> .foo', array('CombinedSelector[Element[div] > Utils[Element[*].foo]]')),
            array('div >.foo', array('CombinedSelector[Element[div] > Utils[Element[*].foo]]')),
            array('div > .foo', array('CombinedSelector[Element[div] > Utils[Element[*].foo]]')),
            array("div \n>  \t \t .foo", array('CombinedSelector[Element[div] > Utils[Element[*].foo]]')),
            array('td.foo,.bar', array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array('td.foo, .bar', array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array("td.foo\t\r\n\f ,\t\r\n\f .bar", array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array('td.foo,.bar', array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array('td.foo, .bar', array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array("td.foo\t\r\n\f ,\t\r\n\f .bar", array('Utils[Element[td].foo]', 'Utils[Element[*].bar]')),
            array('div, td.foo, div.bar span', array('Element[div]', 'Utils[Element[td].foo]', 'CombinedSelector[Utils[Element[div].bar] <followed> Element[span]]')),
            ...
            array('div div:nth-of-type(10) .aclass', array("CombinedSelector[CombinedSelector[Element[div] <followed> Function[Element[div]:nth-of-type(['10'])]] <followed> Utils[Element[*].aclass]]")),
            ...
            array('div:not(div.foo)', array('Negation[Element[div]:not(Utils[Element[div].foo])]')),
            array('td ~ th', array('CombinedSelector[Element[td] ~ Element[th]]')),
            array('.foo[data-bar][data-baz=0]', array("Attribute[Attribute[Utils[Element[*].foo][data-bar]][data-baz = '0']]")),
        );
    }
    ...
    public function getPseudoElementsTestData()
    {
        return array(
            ...
            array('lorem#ipsum ~ a#b.c[href]:empty::selection', 'CombinedSelector[Hash[Element[lorem]#ipsum] ~ Pseudo[Attribute[Utils[Hash[Element[a]#b].c][href]]:empty]]', 'selection'),
        );
    }
