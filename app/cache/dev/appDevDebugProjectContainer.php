...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gsb', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\GestionFraisBundle\\Entity'))), 'GestionFraisBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('GestionFraisBundle' => 'GestionFraisBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_693d86b2f09d13e07b81918760fe17c1bb7fed5672d2540d1b9466319f942118');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('GestionFraisBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('GestionFraisBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('GestionFraisBundle\\Entity\\Visiteur');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('GestionFraisBundle\\Entity\\Visiteur');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'GestionFraisBundle\\Entity\\Visiteur');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/utilisateur');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/comptable');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\GestionFraisBundle/Resources/views'), 'GestionFrais');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c78c41b414fef57bf9448c79402f6dca6ecac0ed');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_UTLISATEUR', 1 => 'ROLE_COMPTABLE', 2 => 'ROLE_ADMINISTRATEUR')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GestionFraisBundle' => 'GestionFraisBundle\\GestionFraisBundle',
            ...
            'secret' => 'c78c41b414fef57bf9448c79402f6dca6ecac0ed',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'c78c41b414fef57bf9448c79402f6dca6ecac0ed',
            ...
            'fos_user.model.user.class' => 'GestionFraisBundle\\Entity\\Visiteur',
