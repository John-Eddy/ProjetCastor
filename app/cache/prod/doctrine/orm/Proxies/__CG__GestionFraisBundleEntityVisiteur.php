 ...
 */
class Visiteur extends \GestionFraisBundle\Entity\Visiteur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'GestionFraisBundle\\Entity\\Visiteur' . "\0" . 'nom', '' . "\0" . 'GestionFraisBundle\\Entity\\Visiteur' . "\0" . 'prenom', '' . "\0" . 'GestionFraisBundle\\Entity\\Visiteur' . "\0" . 'adresse', '' . "\0" . 'GestionFraisBundle\\Entity\\Visiteur' . "\0" . 'cp', '' . "\0" . 'GestionFraisBundle\\Entity\\Visiteur' . "\0" . 'ville', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
